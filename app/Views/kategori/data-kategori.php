                            ...
                            <tbody>
                                ...
                                <?php foreach ($listKategori as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                        <td>
                      <a href=<?=site_url('/edit-kategori/'.$row['id_kategori']); ?>><i class="bi bi-pencil-square"></i></a>
                      <a href=<?=site_url('/hapus-kategori/'.$row['id_kategori']); ?>><i class="bi bi bi-trash-fill"></i></a>
                    </td>
                                        </td>
